...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  const result = sortHotelsByPricing(hotels, pricing);
...
app.get('/hotels/filter/amenity', (req, res) => {
  ...
  let result = filterHotelsByAmenity(hotels, amenity);
  res.json({ hotels: result });
});
...
app.get('/hotels/filter/country', (req, res) => {
  ...
  let result = filterHotelsByCountry(hotels, country);
  res.json({ hotels: result });
});
...
app.get('/hotels/filter/category', (req, res) => {
  ...
  let result = filterHotelsByCategory(hotels, category);
  res.json({ hotels: result });
});
